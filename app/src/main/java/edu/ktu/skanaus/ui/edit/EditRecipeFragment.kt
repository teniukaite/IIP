...
import edu.ktu.skanaus.MyOnBackPressed
import edu.ktu.skanaus.R
import edu.ktu.skanaus.database.SkanausDatabase
import edu.ktu.skanaus.databinding.FragmentEditRecipeBinding
import edu.ktu.skanaus.ui.recipe.RecipeFragmentArgs
...
class EditRecipeFragment : Fragment(), MyOnBackPressed {
    ...
    override fun onCreateView(
        ...
        val recipeDao = SkanausDatabase.getInstance(application).recipeDao
        val ingredientDao = SkanausDatabase.getInstance(application).ingredientDao
        val instructionDao = SkanausDatabase.getInstance(application).instructionDao
