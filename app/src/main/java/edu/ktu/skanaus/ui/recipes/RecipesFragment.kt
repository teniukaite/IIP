...
import edu.ktu.skanaus.MainActivity
import edu.ktu.skanaus.R
import edu.ktu.skanaus.database.SkanausDatabase
import edu.ktu.skanaus.databinding.FragmentRecipesBinding
import edu.ktu.skanaus.util.toggleIsDaySharedPref
...
class RecipesFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val searchDao = SkanausDatabase.getInstance(application).searchDao
