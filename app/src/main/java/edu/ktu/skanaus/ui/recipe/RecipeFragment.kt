...
import edu.ktu.skanaus.ui.recipe.RecipeViewModel
import edu.ktu.skanaus.R
import edu.ktu.skanaus.database.SkanausDatabase
import edu.ktu.skanaus.databinding.FragmentRecipeBinding
...
class RecipeFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val dataSource = SkanausDatabase.getInstance(application).recipeDao
